This is my personal `.ideavimrc` file that is very likely usuitable for anyone other than myself. Made for Swedish keyboards as the `ö` key is used for Esc and `Ö` for command mode.
